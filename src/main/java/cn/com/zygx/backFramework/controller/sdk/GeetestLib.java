package cn.com.zygx.backFramework.controller.sdk;
...
public class GeetestLib {
	...
	/**
	 * 极验验证二次验证表单数据 username
	 */
	public static final String fn_geetest_username = "username";
	
	/**
	 * 极验验证二次验证表单数据 password
	 */
	public static final String fn_geetest_password = "password";

	/**
	 * 极验验证二次验证表单数据 password
	 */
	public static final String fn_geetest_rememberMe = "rememberMe";
