...
<title>编辑字典菜单 - 系统管理</title>
<meta name="keywords" content="H-ui.admin v2.3,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
<meta name="description" content="H-ui.admin v2.3，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal"  id="dicMenu_update_form" method="post" accept-charset="utf-8">
	<input type="hidden"  name="id" value="${sys_dic_menu.id}"/>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>字典代码（英文）：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="${sys_dic_menu.dic_code}"  placeholder="字典代码（只支持英文）"  name="dic_code">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>字典名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off"  value="${sys_dic_menu.dic_name}" placeholder="字典名称"  name="dic_name">
		</div>
	</div>
	<div class="row cl">
...
<script type="text/javascript">
		$(function(){
			...
			$("#is_valid").val("${sys_dic_menu.is_valid}");
			
			$("#update_btn").click(function(){
				show_loading('${ctx}');
				$.ajax({
					url:'${ctx}/admin/sys/dic/updateDicMenu',
					type:'POST',
					data:$("#dicMenu_update_form").serialize(),
					dataType:'json',
