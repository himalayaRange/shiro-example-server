...
<title>添加菜单节点- 系统管理</title>
<meta name="keywords" content="H-ui.admin v2.3,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
<meta name="description" content="H-ui.admin v2.3，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal"  id="tree_add_form" method="post" accept-charset="utf-8">
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" maxlength="200" name="url" id="url" class="input-text" />
		</div>
	</div>
	<div class="row cl">
...
<script type="text/javascript">
	$(function(){
		...
		$("#add_btn").click(function(){
			$.ajax({
				url:'${ctx}/admin/sys/menu/addTree',
				type:'POST',
				data:$("#tree_add_form").serialize(),
				dataType:'json',
