...
String path = request.getContextPath();
      ...
      out.write("<div class=\"pos-a\" style=\"width:200px;left:0;top:0; bottom:0; height:100%; border-right:1px solid #e5e5e5; background-color:#f5f5f5\">\r\n");
      out.write("\t<ul id=\"treeDemo\" class=\"ztree\">\r\n");
      out.write("\t</ul>\r\n");
      out.write("</div>\r\n");
      out.write("<div style=\"margin-left:200;\">\r\n");
      out.write("<nav class=\"breadcrumb\"><i class=\"Hui-iconfont\">&#xe67f;</i> 首页 <span class=\"c-gray en\">&gt;</span> 系统管理 <span class=\"c-gray en\">&gt;</span> 菜单管理 <a class=\"btn btn-success radius r\" style=\"line-height:1.6em;margin-top:3px\" href=\"javascript:location.replace(location.href);\" title=\"刷新\" ><i class=\"Hui-iconfont\">&#xe68f;</i></a></nav>\r\n");
      ...
      out.write("\t\t<input type=\"text\" class=\"input-text\" style=\"width:250px\" placeholder=\"输入节点名称\" id=\"\" name=\"\">\r\n");
      out.write("\t\t<button type=\"submit\" class=\"btn btn-success\" id=\"\" name=\"\"><i class=\"Hui-iconfont\">&#xe665;</i> 搜菜单</button>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"cl pd-5 bg-1 bk-gray mt-20\"> \r\n");
      out.write("\t\t<span class=\"l\"> <a href=\"javascript:;\" onclick=\"tree_add('添加菜单节点','");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/sys/menu/add','800','500')\" class=\"btn btn-primary radius\"><i class=\"Hui-iconfont\">&#xe600;</i> 添加菜单节点</a></span> <span class=\"r\">共有数据：<strong>12</strong> 条</span>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<table class=\"table table-border table-bordered table-bg table-hover radius\">\r\n");
      out.write("\t\t<thead>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th scope=\"col\" colspan=\"14\">菜单节点列表</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"text-c\">\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\"><input name=\"\" type=\"checkbox\" value=\"\"></th>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\">节点ID</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\">父节点ID</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"10%\">节点名称</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"10%\">自定义图标</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"10%\">链接</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\">打开方式</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\">排序</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"10%\">创建时间</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"10%\">修改时间</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\">是否展开</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\">节点属性</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\">是否隐藏</th>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t/*菜单树-添加*/\r\n");
      out.write("\tfunction tree_add(title,url,w,h){\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t/*菜单树-编辑*/\r\n");
      out.write("\tfunction tree_edit(title,url,w,h){\r\n");
      out.write("\t\tvar index = layer.open({\r\n");
      out.write("\t\t\ttype: 2,\r\n");
      out.write("\t\t\ttitle: title,\r\n");
      out.write("\t\t\tcontent: url\r\n");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${nodeList}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.iconSkin}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.url}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.target}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.orders}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
          ...
          out.write("\t\t\t\t\t</td>\r\n");
          out.write("\t\t\t\t\t<td>\r\n");
          out.write("\t\t\t\t\t\t<a title=\"编辑\" href=\"javascript:;\" onclick=\"tree_edit('菜单树编辑','");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("/admin/sys/tree/update/");
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.open==true}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<span class=\"label label-success radius\">展开</span>");
  ...
  private boolean _jspx_meth_c_if_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.open==false}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_1 = _jspx_th_c_if_1.doStartTag();
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<span class=\"label label-warning radius\">关闭</span>");
  ...
  private boolean _jspx_meth_c_if_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.isParent==true}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_2 = _jspx_th_c_if_2.doStartTag();
    if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<span class=\"label  label-danger  radius\">父子节点</span>");
  ...
  private boolean _jspx_meth_c_if_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.isParent==false}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_3 = _jspx_th_c_if_3.doStartTag();
    if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<span class=\"label label-secondary  radius\">叶子节点</span>");
  ...
  private boolean _jspx_meth_c_if_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.isHidden==true}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_4 = _jspx_th_c_if_4.doStartTag();
    if (_jspx_eval_c_if_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<span class=\"label  label-danger  radius\">隐藏</span>");
  ...
  private boolean _jspx_meth_c_if_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_5.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.isHidden==false}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_5 = _jspx_th_c_if_5.doStartTag();
    if (_jspx_eval_c_if_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<span class=\"label label-secondary  radius\">显示</span>");
