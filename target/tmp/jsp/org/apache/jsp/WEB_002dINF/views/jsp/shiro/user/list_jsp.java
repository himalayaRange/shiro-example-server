package org.apache.jsp.WEB_002dINF.views.jsp.shiro.user;
...
String path = request.getContextPath();
      ...
      out.write("\t\t<span class=\"l\"> <a href=\"javascript:;\" onclick=\"admin_add('添加管理员','");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/user/add','800','500')\" class=\"btn btn-primary radius\"><i class=\"Hui-iconfont\">&#xe600;</i> 添加管理员</a></span> <span class=\"r\">共有数据：<strong>12</strong> 条</span>\n");
      out.write("\t</div>\n");
      out.write("\t<table class=\"table table-border table-bordered table-bg table-hover radius\">\n");
      out.write("\t\t<thead>\n");
      out.write("\t\t\t<tr>\n");
      out.write("\t\t\t\t<th scope=\"col\" colspan=\"7\">管理员列表</th>\n");
      out.write("\t\t\t</tr>\n");
      ...
      out.write("\t\t\t\t<th width=\"15%\">用户昵称</th>\n");
      out.write("\t\t\t\t<th width=\"15%\">角色</th>\n");
      out.write("\t\t\t\t<th width=\"15%\">启用状态</th>\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("/*管理员-资源访问权限*/\n");
      out.write("function admin_res(title,url,w,h){\n");
      out.write("\tvar index = layer.open({\n");
      out.write("\t\ttype: 2,\n");
      out.write("\t\ttitle: title,\n");
      out.write("\t\tcontent: url\n");
      ...
      out.write("}\n");
      out.write("/*管理员-停用*/\n");
      out.write("function admin_stop(userId){\n");
      out.write("\tlayer.confirm('确认要禁用该用户？',function(index){\n");
      out.write("\t\tlayer.closeAll();\n");
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/user/jy/'+userId,\n");
      out.write("\t\t\ttype:'POST',\n");
      ...
      out.write("\t\t\t\t      show_msg(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\",'用户禁用成功！  正在为您跳转...','javascript:location.replace(location.href);',1000);\n");
      out.write("\t\t\t\t}else {\n");
      ...
      out.write("\n");
      out.write("/*管理员-启用*/\n");
      out.write("function admin_start(userId){\n");
      out.write("\tlayer.confirm('确认要启用该用户？',function(index){\n");
      out.write("\t\tlayer.closeAll();\n");
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/admin/user/qy/'+userId,\n");
      out.write("\t\t\ttype:'POST',\n");
      out.write("\t\t\tdataType:'json',\n");
      out.write("\t\t\tsuccess:function(data){\n");
      out.write("\t\t\t\tif(data.success){\n");
      out.write("\t\t\t\t      show_msg(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\",'用户启用成功！  正在为您跳转...','javascript:location.replace(location.href);',1000);\n");
      out.write("\t\t\t\t}else {\n");
      out.write("\t\t\t\t\tshow_err_msg(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\",data.emsg);\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.nickname}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("\t\t\t\t\t<td >");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.roles}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("\t\t\t\t\t");
          ...
          if (_jspx_meth_c_if_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_forEach_0, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
            return true;
          out.write("\n");
          out.write("\t\t\t\t\t\t<a title=\"编辑\" href=\"javascript:;\" onclick=\"admin_edit('管理员编辑','");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("/admin/user/update/");
          ...
          out.write("\t\t\t\t\t\t</a>\n");
          out.write("\t\t\t\t\t\t<a title=\"访问资源权限\" href=\"javascript:;\" onclick=\"admin_res('资源访问权限','");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("/admin/user/listRes/");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("','800','500')\" class=\"ml-5\" style=\"text-decoration:none\">\n");
          out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success-outline radius\">资源权限</button>\n");
          out.write("\t\t\t\t\t\t</a>\n");
          out.write("\t\t\t\t\t</td>\n");
          out.write("\t\t\t\t\n");
          out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.status==1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.status==0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.status==0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_2 = _jspx_th_c_if_2.doStartTag();
    if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t<a style=\"text-decoration:none\" onClick=\"admin_start('");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("')\" href=\"javascript:;\" title=\"启用\">\n");
        out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success-outline radius\">启用</button>\n");
        out.write("\t\t\t\t\t\t</a> \n");
        out.write("\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_if_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.status==1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_3 = _jspx_th_c_if_3.doStartTag();
    if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t<a style=\"text-decoration:none\" onClick=\"admin_stop('");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("')\" href=\"javascript:;\" title=\"停用\">\n");
        out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-danger-outline radius\">禁用</button>\n");
        out.write("\t\t\t\t\t\t</a> \n");
        out.write("\t\t\t\t\t\t");
